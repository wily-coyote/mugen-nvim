...
syn region zssSection start="^\s*\[" end="\]" contains=zssNumber,zssComment,zssSpecialCharacters,zssFunctionDefinition
syn match zssSpecialCharacters /[\;\-\\:\+]/ contained
syn region zssFunctionDefinition start=/(/ end=/)\(\s+[a-zA-Z\.\_][a-zA-Z0-9\.\_]\{}\)\?/ contained contains=zssIdentifierFunction
